...
| [Azure Pipelines](https://azure.microsoft.com/en-us/services/devops/pipelines/) | macOs            | Temporarily disabled due this GitHub issue: [Unattended install of Docker Desktop (Windows and macOS)](https://github.com/docker/roadmap/issues/80).                                                                                                            |
