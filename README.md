...
This repo shows ASP.NET Core v3.x logging in action; it also serves as a learning, experimenting and teaching path to [Azure Pipelines](https://azure.microsoft.com/en-us/services/devops/pipelines/).  
...
:exclamation: Please restart the terminal where you have run the above command to ensure `dotnet ef` is recognized.
