namespace Todo.ApplicationFlows.TodoItems
{
    ...
    public class FetchTodoItemsFlow : TransactionalBaseApplicationFlow<TodoItemQuery, IList<TodoItemInfo>>, IFetchTodoItemsFlow
    {
        ...
        public FetchTodoItemsFlow(ITodoItemService todoItemService, ApplicationFlowOptions applicationFlowOptions, ILogger<FetchTodoItemsFlow> logger)
        ...
        protected override async Task<IList<TodoItemInfo>> ExecuteFlowStepsAsync(TodoItemQuery input, IPrincipal flowInitiator)
        {
