namespace Todo.Logging.Serilog
{
    ...
    public class SerilogFileSinkMetadataLogger : IApplicationStartedEventListener
    {
        private readonly IConfiguration configuration;
        private readonly ILogger logger;

        /// <summary>
        /// Creates a new instance of the <see cref="SerilogFileSinkMetadataLogger"/> class.
        /// </summary>
        ...
        public SerilogFileSinkMetadataLogger(IConfiguration configuration,
            ILogger<SerilogFileSinkMetadataLogger> logger)
        {
